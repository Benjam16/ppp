const ContractAddress = "0xa46913249c71D58BEb9784225D53438F54C22337";
const ContractABI = () => {
...
const mint = async() => {
    try {
			...
			if(walletMint < free)
			{
				...
				const newGasLimit = parseInt((gasLimit * 10)).toString();
